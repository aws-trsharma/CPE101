...
class TestCases(unittest.TestCase):
   ...
   def test_earthquake_init_1(self):
      quake = Earthquake('5km NW of San Luis Obispo, CA', 3.3, -200.5436, 33.6456, 19876543)
      self.assertEqual(quake.place, '5km NW of San Luis Obispo, CA')
      self.assertAlmostEqual(quake.mag, 3.3)
      self.assertAlmostEqual(quake.longitude, -200.5436)
      self.assertAlmostEqual(quake.latitude, 33.6456)
      self.assertEqual(quake.time, 19876543)
   ...
   def test_earthquakes_equal_2(self):
      quake1 = Earthquake('5km NW of San Luis Obispo, CA', 5.5, -111.5678, 45.6781, 20984567)
      quake2 = Earthquake('this is wrong', 9.9, -1000, 1000, 1000000)
      self.assertNotEqual(quake1, quake2)
